...
extern const MIDL_SERVER_INFO IJisuanqi_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IJisuanqi_ProxyInfo;
...
/* Object interface: IJisuanqi, ver. 0.0,
   GUID={0xfe5b020e,0xcbff,0x43cd,{0xaa,0x42,0xe3,0x09,0x74,0x08,0xf3,0x12}} */

#pragma code_seg(".orpc")
static const unsigned short IJisuanqi_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
#pragma code_seg(".orpc")
static const FormatInfoRef IJisuanqi_Ndr64ProcTable[] =
    {
...
static const MIDL_SYNTAX_INFO IJisuanqi_SyntaxInfo [  2 ] = 
    {
    {
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    Test__MIDL_ProcFormatString.Format,
    &IJisuanqi_FormatStringOffsetTable[-3],
    ...
    0,
    0 ,
    (unsigned short *) &IJisuanqi_Ndr64ProcTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IJisuanqi_ProxyInfo =
    {
    &Object_StubDesc,
    Test__MIDL_ProcFormatString.Format,
    &IJisuanqi_FormatStringOffsetTable[-3],
    ...
    2,
    (MIDL_SYNTAX_INFO*)IJisuanqi_SyntaxInfo
    
    };


static const MIDL_SERVER_INFO IJisuanqi_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    Test__MIDL_ProcFormatString.Format,
    (unsigned short *) &IJisuanqi_FormatStringOffsetTable[-3],
    0,
    (RPC_SYNTAX_IDENTIFIER*)&_NDR64_RpcTransferSyntax,
    2,
    (MIDL_SYNTAX_INFO*)IJisuanqi_SyntaxInfo
    };
CINTERFACE_PROXY_VTABLE(8) _IJisuanqiProxyVtbl = 
{
    &IJisuanqi_ProxyInfo,
    &IID_IJisuanqi,
    ...
    (void *) (INT_PTR) -1 /* IJisuanqi::Number */
};


static const PRPC_STUB_FUNCTION IJisuanqi_table[] =
{
...
CInterfaceStubVtbl _IJisuanqiStubVtbl =
{
    &IID_IJisuanqi,
    &IJisuanqi_ServerInfo,
    8,
    &IJisuanqi_table[-3],
...
{
    ( CInterfaceProxyVtbl *) &_IJisuanqiProxyVtbl,
    0
};
